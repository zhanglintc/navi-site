...
function Copyright() {
    copyright.innerHTML =  "&copy 2018-" + (new Date()).getFullYear() + " by <a style='color: unset;' target='_blank' href='http://github.com/zhanglintc/navi-site'>zhanglintc</a>";
}
